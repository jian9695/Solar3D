...
SolarRadiation Utils::getTotalIrradiance(int dayofyear, double linke, double elevation, double solarAzimuth, double solarZenith, double surfaceAzimuth, double surfaceTilt, bool isShadowed)
{
	...
	double di = dni * cos(cosinc * DEG_TO_RAD);
